<x-app-layout>
                    ...
                    <div class="md:col-span-1 space-y-6">
                        <div class="glass rounded-2xl p-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="total" id="total" value="{{ old('total') }}" required min="0" step="1" x-model="total" readonly
                        ...
                        <div class="glass rounded-2xl p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div x-show="items.length === 0" class="text-center py-8 text-gray-500 text-sm">
                                    Belum ada item ditambahkan. Klik "Tambah Item" untuk memulai.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function receiptForm() {
            return {
                items: [
                    { id: Date.now(), name: '', categoryId: '', price: 0, qty: 1 }
                ],
                total: 0,
