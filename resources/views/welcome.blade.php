...
<body class="bg-surface-900 text-white font-sans antialiased overflow-x-hidden">
    ...
    <!-- Footer -->
    <footer class="py-16 bg-surface-900 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400 leading-relaxed">Aplikasi Pengarsipan Struk Cerdas berbasis AI untuk membantu Anda mencatat dan mendigitalisasi dokumen struk belanja dengan lebih mudah.</p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#features" class="text-sm text-gray-400 hover:text-primary-400 transition-colors">Fitur Unggulan</a></li>
                        <li><a href="#how-it-works" class="text-sm text-gray-400 hover:text-primary-400 transition-colors">Cara Kerja</a></li>
                        @if (Route::has('login'))
                            <li><a href="{{ route('login') }}" class="text-sm text-gray-400 hover:text-primary-400 transition-colors">Masuk</a></li>
                            @if (Route::has('register'))
                                <li><a href="{{ route('register') }}" class="text-sm text-gray-400 hover:text-primary-400 transition-colors">Daftar Gratis</a></li>
                            @endif
                        @endif
                    </ul>
                </div>
                ...
                <!-- Tim Pengembang -->
                <div>
                    <h4 class="text-sm font-semibold text-white uppercase tracking-wider mb-4">Tim Pengembang</h4>
                    <ul class="space-y-3">
                        <li class="text-sm text-gray-400">Aldy Permana</li>
                        <li class="text-sm text-gray-400">Andi Muchamad Mugni P</li>
                        <li class="text-sm text-gray-400">Dhaffa Zikrullah Ramadhan</li>
                        <li class="text-sm text-gray-400">Dimas Rizqia Hidayat</li>
                    </ul>
                    <a href="https://github.com/aldypermana20/Strukify" target="_blank" class="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors mt-4">
            ...
            <div class="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <p class="text-xs text-gray-500">Made with ❤️ by Tim Strukify — UIN Sunan Gunung Djati Bandung</p>
            </div>
        </div>
    </footer>
